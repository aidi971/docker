  ...
  <el-card style="width: 500px" v-loading="loading">
    <div>
      <div style="text-align: left">
        <el-form :model="emailValidateForm" label-position="top"
          ...
          <el-form-item
            ...
            <el-input type="email" v-model.email="emailValidateForm.email"
                      auto-complete="off" style="width: 300px"
                      placeholder="请输入邮箱地址" size="mini"></el-input>
            <el-button type="primary" @click="submitForm('emailValidateForm')"
                       size="mini">确定
            </el-button>
          </el-form-item>
        </el-form>
